...
public class TilesConfig extends WebMvcConfigurerAdapter {
    ...
    public TilesConfigurer tilesConfigurer() {
        ...
        addBaseDefinition("create_topic", "edit_topic", "Create New Topic", "<i class='fa fa-file-o fa-fw'></i>",
                Boolean.TRUE);
        addBaseDefinition("topics_list", "Topics", "<i class='fa fa-tags fa-fw'></i>", Boolean.FALSE);

        // Topics Views
        addBaseDefinition("edit_twitter_api_key", "Edit Twitter API Key", "<i class='fa fa-pencil fa-fw'></i>", Boolean.FALSE);
        addBaseDefinition("create_twitter_api_key", "edit_twitter_api_key", "Create New Twitter API Key", "<i class='fa fa-file-o fa-fw'></i>",
                Boolean.FALSE);
