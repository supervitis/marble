...
@Document(collection = "streaming_statuses")
public class StreamingStatus {
    ...
    private StreamingStatus retweetedStatus;
    ...
    public StreamingStatus(StreamingStatus status) {
        this.streamingTopicId = status.getStreamingTopicId();
    ...
    public StreamingStatus(twitter4j.Status status, Integer topicId) {
        ...
        if (status.getRetweetedStatus() != null) {
            this.retweetedStatus = new StreamingStatus(status.getRetweetedStatus(), null);
        }
        this.userMentionEntities = status.getUserMentionEntities();
        this.urlEntities = status.getURLEntities();
        this.hashtagEntities = status.getHashtagEntities();
    ...
    public StreamingStatus getRetweetedStatus() {
        return retweetedStatus;
    }

    public void setRetweetedStatus(StreamingStatus retweetedStatus) {
