...
import org.marble.commons.executor.processor.BagOfWordsSenticProcessorExecutor;
...
public class ValidationResult {
    ...
    public String getResults() {
        ...
        results += "Percentage of success in positives:......<" + (((float)this.totalPositiveSuccesses / (float)this.totalOriginalPositiveItems) * 100F) + "%>\n";
        ...
        results += "Percentage of success in neutrals:.......<" + (((float)this.totalNeutralSuccesses / (float)this.totalOriginalNeutralItems) * 100F) + "%>\n";
        ...
        results += "Percentage of success in negatives:......<" + (((float)this.totalNegativeSuccesses / (float)this.totalOriginalNegativeItems) * 100F) + "%>\n";
