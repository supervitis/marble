	...
	<div class="col-lg-12">
		<div class="panel panel-default">
			<div class="panel-body">
				<fieldset>
					<p class="help-block">
						<spring:message code="streaming_topics_list.form.informative_message" />
					</p>
					<div class="form-group">
						<div class="col-lg-offset-10 col-lg-2">
							<a href="<c:url value="streaming_topic/create"/>" class="btn btn-primary pull-right">
				...
				<c:if test="${not empty streaming_topics}">
					<div class="table-responsive">
						<table class="table data-table table-striped table-bordered table-hover">
							<thead>
								<tr>
									<th scope="col"><spring:message code="streaming_topics_list.form.name" /></th>
									<th scope="col"><spring:message code="streaming_topics_list.form.actions" /></th>
								</tr>
							</thead>
							<c:forEach var="streaming_topic" items="${streaming_topics}">
								<tr>
									<td>${streaming_topic.name}</td>
									<td><a href="<c:url value="streaming_topic/${streaming_topic.id}"/>" class="btn btn-default">
											<i class="fa fa-info-circle"></i><span class="hidden-xs hidden-sm"> <spring:message
													code="streaming_topics_list.form.info" /></span>
										</a> <a href="<c:url value="streaming_topic/${streaming_topic.id}/execution/extract"/>" class="btn btn-default btn-light-green">
