	...
	<div class="col-lg-12">
		<div class="panel panel-default">
			<div class="panel-body">
				<fieldset>
					<p class="help-block">
						<spring:message code="datasets_list.form.instagram_topic_informative_message" />
					</p>
					<div class="form-group">
						<div class="col-lg-offset-10 col-lg-2">
...
<div class="row">
	<div class="col-lg-12">
		<div class="panel panel-default">
			<div class="panel-heading">
				<spring:message code="datasets_list.form.instagram_topics" />
			</div>
			<!-- .panel-heading -->
			<div class="panel-body">
						...
						<table
							...
							<c:forEach var="instagram_topic" items="${instagram_topics}">
								<tr>
									...
									<td>${instagram_topic.description}</td>
									<td><a href="<c:url value="instagram_topic/${instagram_topic.id}/edit"/>"
										class="btn btn-default"><i class="fa fa-pencil"></i> <spring:message
												code="datasets_list.form.edit" /></a><a
										href="<c:url value="instagram_topic/${instagram_topic.id}/download"/>"
										class="btn btn-default"><i class="fa fa-download"></i> <spring:message
												code="datasets_list.form.download" /></a></td>
								</tr>
							</c:forEach>
