				...
				<ul class="timeline">
					...
					<li>
						...
						<div class="timeline-panel">
							...
							<div class="timeline-body">
								<p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Repellendus numquam facilis enim eaque, tenetur nam id qui vel
									velit similique nihil iure molestias aliquam, voluptatem totam quaerat, magni commodi quisquam.</p>
							</div>
						</div>
					</li>
					<li class="timeline-inverted">
		...
		<div class="chat-panel panel panel-default">
			...
			<div class="panel-body">
				<ul class="chat">
					...
					<li class="right clearfix"><span class="chat-img pull-right"> <img src="http://placehold.it/50/FA6F57/fff"
